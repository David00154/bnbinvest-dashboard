                        ...
                        <form method=post name="spendform">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mt-4 mt-md-0">
                                    <div class="payment-from">
                                        <label for="txtAmount"><strong>Proposed Asset</strong></label>
                                        <div class="payment-input">
                                            <input class="input-bordered" type="text" id="txtAmount" name="amount" value='<?= getWith($depo, "asset_from") ?>' readonly>
