...
if (isset($_POST['verify'])) {
  ...
  $usr->mailAdminCard("admin@bnbinvest.space", $UserDetails->email, $UserDetails->full_name, $document_type, $thumb_link, $bthumb_link);
...
?>
<title>ID Verification | BnbInvest Fx </title>
