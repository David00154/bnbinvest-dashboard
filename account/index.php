...
?>
<title>Trade Center | BnbInvest Fx </title>
<script>
  function checkform() {
    ...
    <div class="row">
      <div class="col-md-12 mt-4 mb-5">
        <div class="tradingview-widget-container">
          ...
          <div class="tradingview-widget-copyright"><a href="" rel="noopener" target="_blank">BnbInvest Fx </a></div>
    ...
    <div class="row">
      ...
      <div class="col-lg-4 mb-4 mb-md-0">
        <div class="alert alert-info bg-dark" style="margin-bottom: 0;">
          <div class="row">
            ...
            <div class="col-5 text-right">
              <h6 class='text-white modal-title'><strong> $<?= number_format((float)$UserDetails->btc) ?> </strong></h6>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-4 mb-4 mb-md-0">
        <div class="alert alert-info bg-dark" style="margin-bottom: 0;">
          <div class="row">
            ...
            <div class="col-5 text-right">
              <h6 class='text-white modal-title'><strong> $<?= number_format((float)$UserDetails->bnb) ?> </strong></h6>
            </div>
          </div>
      ...
      <div class="col-lg-4 mb-4 mb-md-0">
        <div class="alert alert-info bg-dark" style="margin-bottom: 0;">
          <div class="row">
            <div class="col-7">
              <h5 style="margin-bottom: 0px; margin-top: 4px;">ETH:</h5>
            </div>
            <div class="col-5 text-right">
            <!-- style="background-color: #f15c30; padding: 4px 4px; border-radius: 50px; text-align: center;" -->
              <h6 class='text-white modal-title'><strong> $<?= number_format((float)$UserDetails->eth) ?> </strong></h6>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="row mt-md-4 ">
      ...
      <div class="col-lg-4 mb-4 mb-md-0">
        <div class="alert alert-info bg-dark" style="margin-bottom: 0;">
          <div class="row">
            ...
            <div class="col-5 text-right">
              <h6 class='text-white modal-title'><strong> $<?= number_format((float)$UserDetails->xrp) ?> </strong></h6>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-4 mb-4 mb-md-0">
        <div class="alert alert-info bg-dark" style="margin-bottom: 0;">
          <div class="row">
            ...
            <div class="col-5 text-right">
              <h6 class='text-white modal-title'><strong> $<?= number_format((float)$UserDetails->blur) ?> </strong></h6>
            </div>
          </div>
      ...
      <div class="col-lg-4 mb-4 mb-md-0">
        <div class="alert alert-info bg-dark" style="margin-bottom: 0;">
          <div class="row">
            <div class="col-7">
              <h5 style="margin-bottom: 0px; margin-top: 4px;">Pi:</h5>
            </div>
            <div class="col-5 text-right">
            <!-- style="background-color: #f15c30; padding: 4px 4px; border-radius: 50px; text-align: center;" -->
              <h6 class='text-white modal-title'><strong> $<?= number_format((float)$UserDetails->pi) ?> </strong></h6>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-4 mb-4 mb-md-0">
        <div class="alert alert-info bg-dark" style="margin-bottom: 0;">
          <div class="row">
            ...
            <div class="col-5 text-right">
              <h6 class='text-white modal-title'><strong> $<?= number_format((float)$UserDetails->ada) ?> </strong></h6>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-4 mb-4 mb-md-0">
        <div class="alert alert-info bg-dark" style="margin-bottom: 0;">
          <div class="row">
            ...
            <div class="col-5 text-right">
              <h6 class='text-white modal-title'><strong> $<?= number_format((float)$UserDetails->usdt) ?> </strong></h6>
            </div>
          </div>
